...
{
    public partial class uc_FQC : UserControl
    {
        ...
        public uc_FQC()
        {
            ...
            com.Open();
            cmd = new SqlCommand("select order_id,order_name,price,status from Orders where status='Cooker Done'", com);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            SqlParameter param = new SqlParameter("@name", "FQC Done");
